...
THUMBNAIL_DIMENSIONS = {"youtube": (1280, 720), "facebook": (1200, 630), "twitter": (1200, 675)}

class ThumbnailPlan:
    """Plan for a thumbnail image."""
    __slots__ = ("plan_id", "topic", "style", "text", "dimensions", "color_scheme", "face_position", "cta_overlay")
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {"plan_id": self.plan_id, "topic": self.topic, "style": self.style, "text": self.text, "dimensions": {"width": self.dimensions[0], "height": self.dimensions[1]}, "color_scheme": self.color_scheme}
