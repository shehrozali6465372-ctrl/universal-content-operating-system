"""CostEvents — event system for cost operations."""
from __future__ import annotations
import time
from typing import Any, Callable, Dict, List, Optional

class CostEvents:
    EVENT_TYPES = ("cost_recorded", "budget_exceeded", "budget_warning", "optimization_applied")
    ...
    def get_log(self, event_type: Optional[str] = None) -> List[Dict[str, Any]]:
        if event_type: return [e for e in self._log if e["event"] == event_type]
