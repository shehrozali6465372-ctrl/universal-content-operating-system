"""PromptEvents — event system for prompt operations."""
...
class PromptEvents:
    """Event bus for prompt intelligence operations."""

    EVENT_TYPES = (
        "prompt_created", "prompt_optimized", "prompt_rendered",
        "template_added", "template_removed", "cot_generated",
        "fewshot_selected", "validation_passed", "validation_failed",
    )
