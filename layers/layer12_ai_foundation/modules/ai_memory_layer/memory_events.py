"""MemoryEvents — event system for memory operations."""
...
class MemoryEvents:
    """Event bus for AI memory layer operations."""

    EVENT_TYPES = (
        "memory_stored", "memory_retrieved", "memory_updated",
        "memory_deleted", "memory_consolidated", "memory_pruned",
        "memory_synced", "memory_corrupted", "memory_full",
    )
