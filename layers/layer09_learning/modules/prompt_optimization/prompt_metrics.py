"""Prompt Metrics — Track prompt optimization performance metrics."""
from __future__ import annotations
from typing import Any, Dict, List


class PromptMetrics:
    """Track metrics across prompt optimization cycles."""
    ...
    def __init__(self) -> None:
        ...
        self._total_variants_tested: int = 0
    ...
    def record_variant_test(self) -> None:
        self._total_variants_tested += 1
    ...
    def get_summary(self) -> Dict[str, Any]:
        return {
            ...
            "total_variants_tested": self._total_variants_tested,
